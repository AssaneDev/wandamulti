                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                ...
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="3">3</span> Services
                                </h4>
                            </div>
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Nombre de projet</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="5">0</span> Projets
                                </h4>
                            </div>
                            <div class="col-6">
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Offres</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="0">0</span> Offres
                                </h4>
                            </div>
                            <div class="col-6">
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Message Reçue</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="4">0</span> Messages
                                </h4>
                            </div>
                            <div class="col-6">
